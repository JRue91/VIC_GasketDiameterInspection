    ...
    async def _trigger_online(self):
        ...
        if bad_status is not None:
            ...
            raise RuntimeError(
                ...
                f"AcquireImage trigger source does not accept a software "
                f"trigger (Vision Suite: 'Software', not 'Input Line'; "
                f"In-Sight Explorer: Manual/Network); the telnet user "
